module.exports = async function handler(req, res) {
    ...
    if (urlPath.includes('/jwt/generate')) {
        return res.status(200).json({
            ...
            message: "Success",
            data: {
                token: "eyJhbGciOiJIUzI1NiJ9.eyJjcmVhdGVkRGF0ZSI6IlN1biBKdW4gMjEgMDg6MjE6NTAgVVRDIDIwMjYiLCJzZXNzaW9uSWQiOiIxNTc1NDcwODkiLCJkZXZpY2VJZCI6IjM3ZTE4NzJhOTc0M2NkMzQiLCJzdWIiOiIxMTkyOTg0MzciLCJleHAiOjE3ODIyODkzMTB9.M8uf-pVd9hcGWAHn11-WADvEqIr5u0uqORZb8D5qx0o"
            }
        });
    }
    ...
    const DEVICE_IDENTITY = {
        deviceId: "37e1872a9743cd34",
        bearerToken: "Bearer eyJhbGciOiJIUzI1NiJ9.eyJjcmVhdGVkRGF0ZSI6IlN1biBKdW4gMjEgMDg6MjE6NTAgVVRDIDIwMjYiLCJzZXNzaW9uSWQiOiIxNTc1NDcwODkiLCJkZXZpY2VJZCI6IjM3ZTE4NzJhOTc0M2NkMzQiLCJzdWIiOiIxMTkyOTg0MzciLCJleHAiOjE3ODIyODkzMTB9.M8uf-pVd9hcGWAHn11-WADvEqIr5u0uqORZb8D5qx0o",
